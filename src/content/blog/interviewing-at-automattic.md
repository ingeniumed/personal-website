...
pubDatetime: 2024-11-02T04:45:23.178Z
title: Interviewing at Automattic
slug: interviewing-at-automattic
featured: true
tags:
  - work
  - automattic
...
This post is meant to be a breakdown of the interview process, based on my successful experience. I would also recommend reading David Artiss's post [here](https://artiss.blog/2019/03/the-automattic-hiring-process/), and Automattic's hiring process post [here](https://automattic.com/how-we-hire/).

## Table of Contents

## The Position

Currently, I am a Senior Software Engineer working on the VIP platform with a focus on our decoupled offering. [Our documentation](https://wpvip.com/wordpress-org-vs-wordpress-com-vs-wordpress-vip/) explains what WordPress VIP is very well:
...
_Note that, I went through this interview process from August to December 2021_

The following are the stages you go through, in the process:
...
- Experience what it's like to use P2 as the preferred way of communication rather than email
...
The golden rule to follow when it comes to decisions, progress updates or really communication is to P2 it. If it’s not on P2, then it didn’t happen.
...
- Weekends: I played it by ear based on how I progressed that week, and what I had planned for the weekend already.
...
![slack-offer-given](@assets/images/slack-offer-given.png)
...
![slack-offer-accepted](@assets/images/slack-offer-accepted.png)
